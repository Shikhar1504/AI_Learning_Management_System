...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              <Link href="/dashboard/upgrade" className="text-muted-foreground hover:text-foreground transition-colors">
                Pricing
              </Link>
            </div>
            ...
            <div className="hidden lg:flex items-center justify-center gap-4">
              <Link href="/dashboard" className="btn-secondary h-9 px-4 flex items-center justify-center">
                Dashboard
              </Link>
              {isSignedIn ? (
                <div className="ml-2">
                ...
                <Link href="/sign-in" className="btn-primary h-9 px-4 flex items-center justify-center">
                  Sign In
                </Link>
              )}
            </div>
              ...
              {isSignedIn && (
                <div className="ml-2">
                  <UserButton 
                    ...
                    appearance={{
                      elements: {
                        avatarBox: "h-8 w-8 rounded-xl border-2 border-purple-400/50 hover:border-purple-400 transition-all shadow-lg",
                        userButtonPopoverCard: "glass-card border border-white/20",
                        userButtonPopoverActionButton: "hover:bg-white/10"
                      }
                    }}
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden glass-card border-t border-white/10 py-4 space-y-2">
              <Link href="#features" className="block text-muted-foreground hover:text-foreground transition-colors py-3 px-4">
                Features
              </Link>
              <Link href="#how-it-works" className="block text-muted-foreground hover:text-foreground transition-colors py-3 px-4">
                How it Works
              </Link>
              <Link href="/dashboard/upgrade" className="block text-muted-foreground hover:text-foreground transition-colors py-3 px-4">
                Pricing
              </Link>
              <Link href="/dashboard" className="block text-muted-foreground hover:text-foreground transition-colors py-3 px-4">
                Dashboard
              </Link>
              {!isSignedIn && (
                <div className="px-4 pt-2">
                  <Link href="/sign-in" className="btn-primary px-6 text-center block">
                    Sign In
                  </Link>
                </div>
              )}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 text-center lg:text-left space-y-8 fade-in">
              ...
              <div className="inline-flex items-center px-4 py-2 rounded-full glass-card border border-purple-400/20">
                ...
                <span className="text-sm font-medium text-purple-400">AI-Powered Learning</span>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                  Experience the future of education with personalized AI courses, interactive study materials, and adaptive learning paths designed specifically for your success.
                </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link href="/dashboard" className="btn-primary  px-6 sm:px-8 text-base sm:text-lg font-semibold whitespace-nowrap hover:scale-105 transition-transform">
                  <span className="truncate">Start Learning Free</span>
                </Link>
                <Link href="#how-it-works" className="btn-secondary  px-6 sm:px-8 text-base sm:text-lg font-semibold whitespace-nowrap hover:scale-105 transition-transform">
            ...
            {/* Right Content */}
            <div className="flex-1 relative scale-in" style={{ animationDelay: '300ms' }}>
              <div className="relative">
                ...
                <div className="relative modern-card p-6 sm:p-6 lg:p-8">
                  <div className="aspect-video rounded-xl overflow-hidden bg-gradient-to-br from-purple-500/10 to-blue-500/10 relative min-h-[200px] sm:min-h-[320px]">
                    {/* Floating Elements */}
                    <div className="absolute top-3 left-3 sm:top-4 sm:left-4 bg-white/10 backdrop-blur-sm rounded-lg p-3 floating" style={{ animationDelay: '0s' }}>
                      <BookOpen className="h-5 w-5 sm:h-5 sm:w-5 text-purple-400" />
                    </div>
                    <div className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-white/10 backdrop-blur-sm rounded-lg p-3 floating" style={{ animationDelay: '1s' }}>
                      <Target className="h-5 w-5 sm:h-5 sm:w-5 text-blue-400" />
                    </div>
                    <div className="absolute bottom-3 left-4 sm:bottom-4 sm:left-6 bg-white/10 backdrop-blur-sm rounded-lg p-3 floating" style={{ animationDelay: '2s' }}>
                    ...
                    <div className="flex items-center justify-center h-full p-6">
                      <div className="text-center space-y-4 sm:space-y-4 w-full max-w-[420px] sm:max-w-sm">
                        ...
                        <div className="space-y-3 sm:space-y-3">
                          <h3 className="text-xl sm:text-xl font-semibold text-foreground">AI Learning Engine</h3>
                          <p className="text-sm sm:text-sm text-muted-foreground px-2">Creating your personalized course...</p>
                          <div className="w-40 sm:w-40 h-2 bg-white/10 rounded-full mx-auto overflow-hidden">
                            <div className="h-full bg-gradient-to-r from-purple-500 to-blue-500 rounded-full animate-[width_2s_ease-in-out_infinite]" style={{ width: '85%' }} />
                          </div>
      ...
      <section id="how-it-works" className="py-20 lg:py-32 px-4 sm:px-6 lg:px-8 slide-up" style={{ animationDelay: '200ms' }}>
        <div className="container mx-auto max-w-7xl">
          {/* Section Header */}
          <div className="text-center mb-16">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
              Three simple steps to transform your learning experience with AI-powered education
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:gap-12 md:grid-cols-3 relative">
            ...
            {/* Step 1 */}
            <div className="modern-card-interactive text-center relative z-10" style={{ animationDelay: '300ms' }}>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-foreground">Define Your Goals</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Tell us what you want to learn, your current knowledge level, and your learning preferences. Our AI analyzes your needs to create a personalized plan.
                </p>
              </div>
            </div>

            {/* Step 2 */}
            <div className="modern-card-interactive text-center relative z-10" style={{ animationDelay: '400ms' }}>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Our advanced AI generates comprehensive study materials including interactive lessons, flashcards, practice questions, and visual aids tailored to your learning style.
                </p>
              </div>
            </div>

            {/* Step 3 */}
            <div className="modern-card-interactive text-center relative z-10" style={{ animationDelay: '500ms' }}>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-foreground">Track & Improve</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Study at your own pace with our intuitive interface. Our AI continuously adapts to your progress, focusing on areas that need improvement.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="py-20 lg:py-32 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="container mx-auto max-w-7xl relative">
          ...
          <div className="text-center mb-16 fade-in">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
              Everything you need for an effective and engaging learning experience
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {/* Feature 1 */}
            <div className="modern-card-interactive h-full min-h-[280px] flex flex-col" style={{ animationDelay: '100ms' }}>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Personalized Courses</h3>
              <p className="text-muted-foreground leading-relaxed flex-1">
                Custom learning paths designed specifically for your goals and learning style with AI-generated content.
              </p>
            </div>

            {/* Feature 2 */}
            <div className="modern-card-interactive h-full min-h-[280px] flex flex-col" style={{ animationDelay: '200ms' }}>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Interactive Flashcards</h3>
              <p className="text-muted-foreground leading-relaxed flex-1">
                Memorize key concepts with smart flashcards that adapt to your knowledge level and learning pace.
              </p>
            </div>

            {/* Feature 3 */}
            <div className="modern-card-interactive h-full min-h-[280px] flex flex-col" style={{ animationDelay: '300ms' }}>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">Adaptive Quizzes</h3>
              <p className="text-muted-foreground leading-relaxed flex-1">
                Test your knowledge with quizzes that focus on your weak areas and reinforce learning effectively.
              </p>
            </div>

            {/* Feature 4 */}
            <div className="modern-card-interactive h-full min-h-[280px] flex flex-col" style={{ animationDelay: '400ms' }}>
              ...
              <p className="text-muted-foreground leading-relaxed flex-1">
                Monitor your learning journey with detailed analytics and performance insights in real-time.
              </p>
            </div>

            {/* Feature 5 */}
            <div className="modern-card-interactive h-full min-h-[280px] flex flex-col" style={{ animationDelay: '500ms' }}>
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">AI Tutoring</h3>
              <p className="text-muted-foreground leading-relaxed flex-1">
                Get instant help and explanations when you're stuck on difficult concepts with our AI assistant.
              </p>
            </div>

            {/* Feature 6 */}
            <div className="modern-card-interactive h-full min-h-[280px] flex flex-col" style={{ animationDelay: '600ms' }}>
              ...
              <p className="text-muted-foreground leading-relaxed flex-1">
                Connect with fellow learners, share knowledge, and collaborate on challenging topics together.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="relative space-y-8 fade-in">
              <div className="space-y-4">
                ...
                <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                  Join thousands of students who are already experiencing the future of education with our AI-powered learning platform.
                </p>
              </div>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link href="/dashboard" className="btn-primary  px-6 sm:px-8 text-base sm:text-lg font-semibold whitespace-nowrap hover:scale-105 transition-all group">
                  <span>Start Learning Now</span>
                </Link>
                <Link href="/dashboard/upgrade" className="btn-secondary  px-6 sm:px-8 text-base sm:text-lg font-semibold whitespace-nowrap hover:scale-105 transition-all group">
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col items-center justify-center space-y-6">
            ...
            <div className="flex items-center gap-6 min-h-[2rem] h-8">
              {/* GitHub */}
              <a href="#" className="text-muted-foreground hover:text-white transition-colors flex items-center justify-center h-full">
