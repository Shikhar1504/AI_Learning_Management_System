  ...
  const GenerateCourseOutline = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your AI-powered course is being created. Check your dashboard for updates.",
      });
    } catch (error) {
      ...
      if (error.response?.status === 429) {
        toast({
          ...
          description:
            "You've reached your daily course creation limit. Upgrade to premium for unlimited courses or try again tomorrow.",
          variant: "destructive",
        });
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 lg:p-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="hidden lg:block mb-12 fade-in">
          ...
          <p className="body-large text-muted-foreground max-w-2xl mx-auto text-center">
            Transform your learning goals into comprehensive, AI-powered courses
            with interactive content and personalized study materials.
          </p>
        </div>

        {/* Progress Stepper */}
        <div
          className="mb-8 lg:mb-12 slide-up"
